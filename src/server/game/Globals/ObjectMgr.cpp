...
void ObjectMgr::LoadItemTemplates()
{
    ...
    do
    {
        ...
        itemTemplate.Bonding        = uint32(fields[87].GetUInt8());
        itemTemplate.Description    = fields[88].GetString();
        itemTemplate.PageText       = fields[89].GetUInt32();
        itemTemplate.LanguageID     = uint32(fields[90].GetUInt8());
        itemTemplate.PageMaterial   = uint32(fields[91].GetUInt8());
        itemTemplate.StartQuest     = fields[92].GetUInt32();
        itemTemplate.LockID         = fields[93].GetUInt32();
        itemTemplate.Material       = int32(fields[94].GetInt8());
        itemTemplate.Sheath         = uint32(fields[95].GetUInt8());
        itemTemplate.RandomProperty = fields[96].GetUInt32();
        itemTemplate.RandomSuffix   = fields[97].GetInt32();
        itemTemplate.Block          = fields[98].GetUInt32();
        itemTemplate.ItemSet        = fields[99].GetUInt32();
        itemTemplate.MaxDurability  = uint32(fields[100].GetUInt16());
        itemTemplate.Area           = fields[101].GetUInt32();
        itemTemplate.Map            = uint32(fields[102].GetUInt16());
        itemTemplate.BagFamily      = fields[103].GetUInt32();
        itemTemplate.TotemCategory  = fields[104].GetUInt32();

        for (uint8 i = 0; i < MAX_ITEM_PROTO_SOCKETS; ++i)
        {
            itemTemplate.Socket[i].Color   = uint32(fields[105 + i*2].GetUInt8());
            itemTemplate.Socket[i].Content = fields[106 + i*2].GetUInt32();
        }

        itemTemplate.socketBonus             = fields[111].GetUInt32();
        itemTemplate.GemProperties           = fields[112].GetUInt32();
        itemTemplate.RequiredDisenchantSkill = uint32(fields[113].GetInt16());
        itemTemplate.ArmorDamageModifier     = fields[114].GetFloat();
        itemTemplate.Duration                = fields[115].GetInt32();
        itemTemplate.ItemLimitCategory       = uint32(fields[116].GetInt16());
        itemTemplate.HolidayId               = fields[117].GetUInt32();
        itemTemplate.ScriptId                = sObjectMgr->GetScriptId(fields[118].GetCString());
        itemTemplate.DisenchantID            = fields[119].GetUInt32();
        itemTemplate.FoodType                = uint32(fields[120].GetUInt8());
        itemTemplate.MinMoneyLoot            = fields[121].GetUInt32();
        itemTemplate.MaxMoneyLoot            = fields[122].GetUInt32();
        ...
        if (dbcitem)
        {
            ...
            {
                sLog->outErrorDb("Item (Entry: %u) does not have a correct sheath id (%u), must be %u .", entry, itemTemplate.Sheath, dbcitem->Sheath);
                if (enforceDBCAttributes)
...
void ObjectMgr::LoadRewardOnKill()
{
    ...
    do
    {
        ...
        mRewOnKill[creature_id] = rewOnKill;
